local cfg = _G.StarConfig or {
	Mode = "Mouse",
	CustomPos = Vector2.new(400, 400),
	Size = 50,
	LineWidth = 2,
	ColorHex = "#0038B8"
}
...
local r, g, b = cfg.ColorHex:gsub("#",""):match("(..)(..)(..)")
